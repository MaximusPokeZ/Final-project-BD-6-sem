...
import org.example.impl.ServiceDeduplication;
...
class ServiceTest {
    ...
    void testServiceDeduplicationOneRule() {
        ...
        try (AdminClient adminClient = createAdminClient();
            ...
            clearTable();
            createAndCheckRuleInPostgreSQL(1L, 1L, "model", 10L, true);
            ...
            String expectedJsonOne = "{\"model\":\"Ivolga\", \"coordX\":1.99, \"state\":\"active\"}";
            String expectedJsonTwo = "{\"model\":\"Moskva\", \"coordX\":12.67, \"state\":\"non-active\"}";
            ...
            Set.of("{\"model\":\"Ivolga\", \"coordX\":1.99, \"state\":\"active\"}",
                    "{\"model\":\"Moskva\", \"coordX\":18, \"state\":\"non-active\"}",
                    "{\"model\":\"Ivolga\", \"coordX\":1.99, \"state\":\"active\", \"coordX2\":\"no\"}",
                    "{\"model\":\"Moskva\", \"coordX\":18, \"state\":\"non-active\", \"coordX2\":\"yes\"}",
    ...
    void testServiceDeduplicationTwoRules() {
        ...
        try (AdminClient adminClient = createAdminClient();
            ...
            clearTable();
            createAndCheckRuleInPostgreSQL(1L, 1L, "model", 10L, true);
            createAndCheckRuleInPostgreSQL(1L, 2L, "coordX", 20L, true);
            ...
            String expectedJsonOne = "{\"model\":\"Ivolga\", \"coordX\":1.99, \"state\":\"active\"}";
            String expectedJsonTwo = "{\"model\":\"Lastochka\", \"coordX\":1.99, \"state\":\"active\"}";
            String expectedJsonThree = "{\"model\":\"Ivolga\", \"coordX\":12.89, \"state\":\"active\"}";
            ...
            Set.of("{\"model\":\"Ivolga\", \"coordX\":1.99, \"state\":\"active\"}",
                    "{\"model\":\"Lastochka\", \"coordX\":1.99, \"state\":\"active\"}",
                    "{\"model\":\"Ivolga\", \"coordX\":12.89, \"state\":\"active\"}",
                    "{\"model\":\"Ivolga\", \"coordX\":1.99, \"state\":\"active\", \"money\":\"no\"}",
                    "{\"model\":\"Lastochka\", \"coordX\":1.99, \"state\":\"active\", \"money\":\"yes\"}",
                    "").forEach(negativeJson -> {
                try {
                    producer.send(new ProducerRecord<>(topicIn, negativeJson)).get();
                } catch (InterruptedException | ExecutionException e) {
    ...
    void testServiceDeduplicationOneRuleIsActiveFalse() {
        ...
        try (AdminClient adminClient = createAdminClient();
            ...
            clearTable();
            createAndCheckRuleInPostgreSQL(1L, 1L, "model", 10L, true);
            createAndCheckRuleInPostgreSQL(1L, 2L, "coordX", 10L, false);
            ...
            String expectedJsonOne = "{\"model\":\"Ivolga\", \"coordX\":1.99, \"state\":\"active\"}";
            String expectedJsonTwo = "{\"model\":\"Lastochka\", \"coordX\":1.99, \"state\":\"active\"}";
            String expectedJsonThree = "{\"model\":\"Ivolga\", \"coordX\":19.99, \"state\":\"active\"}";
            ...
            Set.of("{\"model\":\"Ivolga\", \"coordX\":1.99, \"state\":\"active\"}",
                    "{\"model\":\"Lastochka\", \"coordX\":1.99, \"state\":\"active\"}",
                    "{\"model\":\"Ivolga\", \"coordX\":19.99, \"state\":\"active\"}",
                    "{\"model\":\"Ivolga\", \"coordX\":1.99, \"state\":\"active\", \"money\":\"no\"}",
                    "{\"model\":\"Lastochka\", \"coordX\":1.99, \"state\":\"active\", \"money\":\"yes\"}",
                    "").forEach(negativeJson -> {
                try {
    ...
    void testServiceDeduplicationNoActiveRules() {
        ...
        try (AdminClient adminClient = createAdminClient();
            ...
            clearTable();
            createAndCheckRuleInPostgreSQL(1L, 1L, "model", 5L, false);
            createAndCheckRuleInPostgreSQL(1L, 2L, "coordX", 10L, false);
    ...
    private Config replaceConfigForTest(Config config) {
        return config.withValue("kafka.consumer.bootstrap.servers", ConfigValueFactory.fromAnyRef(kafka.getBootstrapServers()))
                ...
                .withValue("kafka.consumer.topics", ConfigValueFactory.fromAnyRef(List.of(topicIn)))
                .withValue("kafka.producer.topic", ConfigValueFactory.fromAnyRef(topicOut))
                .withValue("kafka.consumer.auto.offset.reset", ConfigValueFactory.fromAnyRef("earliest"));
    }
